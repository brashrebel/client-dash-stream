...
/**
 * Class CDStream_Settings
 *
 * If you do NOT want to use custom widgets, free to delete this file and the
 * "include_once( "{$CDStream::$_path}inc/settings.php" );" line in the main boilerplate file.
 */
class CDStream_Settings extends ClientDash_Settings_API {
    ...
    public function register_settings() {
        ...
        self::register_field( "cd_options_$this->ID", $this->_settings_ID, 'fun' );
    }
    ...
    public function settings_output() {
        ...
        echo self::text_field($this->_settings_ID, 'fun', 'Fun Stuff');
