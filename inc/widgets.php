 ...
 * "include_once( "{$CDStream::$_path}inc/widgets.php" );" line in the main boilerplate file.
 */
class CDStream_Widgets extends ClientDash_Widgets_API {
